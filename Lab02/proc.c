...
char *syscall_names[27] = {"", "fork", "exit", "wait", "pipe", "read", "kill", "exec", "fstat", "chdir", "dup", "getpid", "sbrk", "sleep",
                           "uptime", "open", "write", "mknod", "unlink", "link", "mkdir", "close", "create_palindrome", "move_file", "sort",
                           "get_most_invoked_syscall", "list_all_pro"};
